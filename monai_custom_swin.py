...
class SwinUNETR(nn.Module):
    ...
    def _check_input_size(self, spatial_shape):
        ...
        if remainder.any():
            ...
            # FIX: Relaxed this check or just printed warning if you prefer, 
            # but standard SwinUNETR requires this divisibility for the bottleneck.
            # Since your grid is 128x128x32 and patch_size=2, 2^5=32.
            # 128%32=0, 32%32=0. It should pass perfectly.
            raise ValueError(
